...
function Datepicker() {
	...
	this.regional = {
		...
		'Июль','Август','Сентябрь','Октябрь','Ноябрь','Декабрь'],
			...
			prevText: '&lt;Пред.', // Text for the previous month command
			prevStatus: 'Пред. месяц', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Пред. год', // Status text for the previous year command
			nextText: 'След.&gt;', // Text for the next month command
			nextStatus: 'След. месяц', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: 'След. год', // Status text for the next year command
			currentText: 'Сегодня', // Text for the current month command
			...
			clearText: 'Очистить', // Text for the clear command
			clearStatus: 'Очистить даты', // Status text for the clear command
			closeText: 'Закрыть', // Text for the close command
			closeStatus: 'Close the datepicker', // Status text for the close command
			yearStatus: 'Change the year', // Status text for year selection
			monthStatus: 'Change the month', // Status text for month selection
			weekText: 'Нд', // Text for week of the year column header
			weekStatus: 'Неделя года', // Status text for week of the year column header
			dayStatus: 'D, M d', defaultStatus: '', // Status text for selectable days
			defaultStatus: 'Выберите дату', // Status text shown by default
