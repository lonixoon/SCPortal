		...
		<div>
				...
				<div class="col-md-12 form-group">
						...
						<div class="col-md-5 alert alert-info">
								<p>Выгружает ситы по которым нет данных (No data) и закрытые ситы (Closed).</p>
						...
						<div class="col-md-5 alert alert-info">
								<p>Витрины если со статусом ОШИБКА, за период с 18:00 предыдущего дня по 23:59 текущего дня.</p>
